...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (trivialContainer) {
    ...
    const questionBank = [
      ...
      { question: '¿Qué tipo de Pokémon es súper efectivo contra el tipo Psíquico en la Gen 1?', options: ['Fantasma', 'Bicho', 'Siniestro', 'Fuego'], answer: 1 },
      ...
      { question: '¿Qué entrenador es el rival de Ash en el anime y en los juegos?', options: ['Gary', 'Brock', 'Misty', 'Erika'], answer: 0 },
      ...
      { question: '¿Qué Pokémon evoluciona a Raichu?', options: ['Pikachu', 'Electabuzz', 'Magnemite', 'Voltorb'], answer: 0 },
